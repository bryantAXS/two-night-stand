...
$config['install_lock'] = "";
$config['license_number'] = "1955-6980-1504-3843";
$config['debug'] = '1';
$config['cp_url'] = "http://thetwonightstand.local/system/index.php";
$config['doc_url'] = "http://expressionengine.com/public_beta/docs/";
$config['is_system_on'] = "y";
$config['site_label'] = 'Two Night Stand';
...
|
*/
$config['base_url']	= "http://thetwonightstand.local/";
